...
export const reco3 = (
  ...
  >
    <div>
      I&apos;ve took part at the Game Connection Paris: the deal making event
      for the video game industry. Game Connection is the international event
      where developers, publishers, distributors and service providers come to
